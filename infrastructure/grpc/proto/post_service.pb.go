...
var file_post_service_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x49, 0x53, 0x4c, 0x49, 0x4b, 0x45, 0x10, 0x01, 0x22, 0xbf,
	...
	0x22, 0x63, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63,
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xc8, 0x02, 0x0a, 0x0b, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x65,
	...
	0x6d, 0x65, 0x7d, 0x12, 0x5b, 0x0a, 0x0b, 0x52, 0x65, 0x61, 0x63, 0x74, 0x54, 0x6f, 0x50, 0x6f,
...
var file_post_service_proto_goTypes = []interface{}{
	...
	(*ReactionRequest)(nil),    // 6: post.ReactionRequest
	(*ReactionResponse)(nil),   // 7: post.ReactionResponse
	(*Reaction)(nil),           // 8: post.Reaction
	(*Post)(nil),               // 9: post.Post
	(*Comment)(nil),            // 10: post.Comment
}
var file_post_service_proto_depIdxs = []int32{
	9,  // 0: post.GetResponse.post:type_name -> post.Post
	9,  // 1: post.GetAllResponse.posts:type_name -> post.Post
	8,  // 2: post.ReactionRequest.reaction:type_name -> post.Reaction
	0,  // 3: post.Reaction.reactionType:type_name -> post.Reaction.ReactionType
	10, // 4: post.Post.comments:type_name -> post.Comment
	1,  // 5: post.PostService.Get:input_type -> post.GetRequest
	3,  // 6: post.PostService.GetAll:input_type -> post.GetAllRequest
	5,  // 7: post.PostService.GetByUser:input_type -> post.GetByUserRequest
	6,  // 8: post.PostService.ReactToPost:input_type -> post.ReactionRequest
	2,  // 9: post.PostService.Get:output_type -> post.GetResponse
	4,  // 10: post.PostService.GetAll:output_type -> post.GetAllResponse
	4,  // 11: post.PostService.GetByUser:output_type -> post.GetAllResponse
	7,  // 12: post.PostService.ReactToPost:output_type -> post.ReactionResponse
