...
type ImageRequest struct {
	...
	//	*ImageRequest_Info
	//	*ImageRequest_Image
	Data isImageRequest_Data `protobuf_oneof:"data"`
}
...
func (m *ImageRequest) GetData() isImageRequest_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *ImageRequest) GetInfo() string {
	if x, ok := x.GetData().(*ImageRequest_Info); ok {
		return x.Info
	}
	return ""
}
...
func (x *ImageRequest) GetImage() []byte {
	if x, ok := x.GetData().(*ImageRequest_Image); ok {
		return x.Image
	}
	return nil
}

type isImageRequest_Data interface {
	isImageRequest_Data()
}

type ImageRequest_Info struct {
	Info string `protobuf:"bytes,1,opt,name=info,proto3,oneof"`
}
...
func (*ImageRequest_Info) isImageRequest_Data() {}

func (*ImageRequest_Image) isImageRequest_Data() {}
...
var file_post_service_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x44, 0x0a, 0x0c, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x61, 0x6d, 0x65, 0x32, 0xaa, 0x05, 0x0a, 0x0b, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76,
	...
	0x3a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x55, 0x0a, 0x0b, 0x55, 0x70, 0x6c,
	...
	0x65, 0x22, 0x1d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x22, 0x12, 0x2f, 0x70, 0x6f, 0x73, 0x74,
	0x2f, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2d, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x3a, 0x01, 0x2a,
...
func file_post_service_proto_init() {
	...
	file_post_service_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ImageRequest_Info)(nil),
		(*ImageRequest_Image)(nil),
	}
	type x struct{}
