...
var file_post_service_proto_rawDesc = []byte{
	...
	0x4b, 0x45, 0x10, 0x01, 0x22, 0x39, 0x0a, 0x07, 0x50, 0x6f, 0x73, 0x74, 0x44, 0x74, 0x6f, 0x12,
...
var file_post_service_proto_depIdxs = []int32{
	...
	22, // 9: post.Post.comments:type_name -> post.Comment
	23, // 10: post.Post.date:type_name -> google.protobuf.Timestamp
	23, // 11: post.Comment.date:type_name -> google.protobuf.Timestamp
	11, // 12: post.PostService.Get:input_type -> post.GetRequest
	13, // 13: post.PostService.GetAll:input_type -> post.GetAllRequest
	15, // 14: post.PostService.GetByUser:input_type -> post.GetByUserRequest
	7,  // 15: post.PostService.CreatePost:input_type -> post.NewPostRequest
	16, // 16: post.PostService.ReactToPost:input_type -> post.ReactionRequest
	4,  // 17: post.PostService.GetFeedPosts:input_type -> post.FeedRequest
	3,  // 18: post.PostService.GetFeedPostsAnonymous:input_type -> post.FeedRequestAnonymous
	9,  // 19: post.PostService.CreateCommentOnPost:input_type -> post.CommentRequest
	1,  // 20: post.PostService.UploadImage:input_type -> post.ImageRequest
	2,  // 21: post.PostService.GetImage:input_type -> post.ImageResponse
	12, // 22: post.PostService.Get:output_type -> post.GetResponse
	14, // 23: post.PostService.GetAll:output_type -> post.GetAllResponse
	14, // 24: post.PostService.GetByUser:output_type -> post.GetAllResponse
	8,  // 25: post.PostService.CreatePost:output_type -> post.NewPost
	17, // 26: post.PostService.ReactToPost:output_type -> post.ReactionResponse
	5,  // 27: post.PostService.GetFeedPosts:output_type -> post.FeedResponse
	5,  // 28: post.PostService.GetFeedPostsAnonymous:output_type -> post.FeedResponse
	10, // 29: post.PostService.CreateCommentOnPost:output_type -> post.CommentResponse
	2,  // 30: post.PostService.UploadImage:output_type -> post.ImageResponse
	1,  // 31: post.PostService.GetImage:output_type -> post.ImageRequest
